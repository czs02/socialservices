<template>
    ...
    <el-table :data="tableData" style="width: 100%;height: calc(100vh - 255px); border-radius: 10px;margin-top: 20px; ">
        ...
        <el-table-column property="name" label="活動成果" />
        <el-table-column property="name" label="反饋" />
        <el-table-column property="name" label="改進建議" />
