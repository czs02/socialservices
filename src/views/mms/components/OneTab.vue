<template>
    ...
    <el-table :data="tableData" style="width: 100%;height: calc(100vh - 255px); border-radius: 10px;margin-top: 20px; ">
        ...
        <el-table-column property="name" label="姓名(中文)" width="100" />
        <el-table-column property="name" label="姓名(英文)" width="100" />
        <el-table-column property="name" label="性別" />
        <el-table-column property="name" label="身份證號碼"  width="100"/>
            <el-table-column label="出生日期" width="120">
            <template #default="scope">{{ scope.row.date }}</template>
        </el-table-column>
        <el-table-column property="name" label="手提電話" />
        <el-table-column property="name" label="住宅電話" />
        <el-table-column property="name" label="練習郵箱" />
        <el-table-column property="name" label="登記日期" />
        <el-table-column property="name" label="聯絡地址" />
        <el-table-column property="name" label="類型" />
        <el-table-column property="name" label="會員狀態" />
        <el-table-column property="name" label="健康狀態" />
        <el-table-column property="name" label="會員並請" />
        <el-table-column property="name" label="精神病患" />
        <el-table-column property="name" label="經濟狀態" />
        <el-table-column property="name" label="緊急聯係人" />
        <el-table-column property="name" label="緊急聯係電話" />
        <el-table-column property="name" label="服務需求" />
...
<!-- 添加或修改结题鉴定对话框 -->
    <!-- <el-dialog  v-model="open" higth="100%" width="500px" append-to-body >
  ...
  <el-row>
      ...
      <el-row>
          <el-col :span="12">
            <el-form-item label="緊急聯係人" >
              <el-input placeholder="请输入" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="緊急聯係人電話" label-width="110px">
              <el-input placeholder="请输入" />
            </el-form-item>
          </el-col>
        </el-row>
